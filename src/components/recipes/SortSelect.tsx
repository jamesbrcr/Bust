...
export default function SortSelect({ value }: { value: string }) {
  ...
  return (
    <div className="relative w-10 h-10 flex items-center justify-center group" title="Sort recipes">
      <svg viewBox="0 0 24 24" width={28} height={28} fill="currentColor" className="text-brand-500 group-hover:text-brand-600 transition-colors pointer-events-none">

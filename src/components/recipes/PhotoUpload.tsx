    ...
    <div>
      <div
        ...
        className={cn(
          ...
          dragging
            ? 'border-brand-400 bg-brand-100 dark:bg-brand-500/10'
            : 'border-gray-200 dark:border-dark-surface hover:border-brand-400 dark:hover:border-brand-500 bg-gray-50 dark:bg-dark-surface',

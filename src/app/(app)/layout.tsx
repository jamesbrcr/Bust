    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-white dark:bg-dark-base border-b border-gray-100 dark:border-dark-surface sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link href="/dashboard" className="text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-brand-500 dark:hover:text-brand-400 transition-colors" style={{ fontFamily: 'var(--font-brand)' }}>
            Bust
          </Link>
